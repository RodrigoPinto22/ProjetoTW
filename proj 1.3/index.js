...
function getInfo() {
    ...
    if (btnValue == 1) {
        ...
        const items1 = [
            `Dara é um jogo de tabuleiro de estratégia abstrata para dois jogadores, jogado em vários paises da África Ocidental, foi inventado no século XIV ou antes.`,
            "Na Nigéria é jogado pelo povo Dakarkari. É popular também jogado em Burkina Faso e em Niger entre os Zarma, onde o jogo é chamado dili.Na língua Hausa ,o jogo é chamado doki, que significa cavalo.",
        ...
        const items3 = [
            ...
            "-Só uma peça é removida por jogada(memsmo sendo formadas várias linhas)",
